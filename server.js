...
const myid = ['581067515338293268']; //هنا بتحط الايدى بتاعك بتاع الديسكورد
const prefix = ['-']; 
...
client.login("NzYzMTc2MDQ2MzE2MDkzNDYw.X32umQ.nE1nH8Agh6CuZp3h06-oZYjNzBY"); 
client2.login("NzYzMzcyMTIxODM2NjE3NzU4.X32whg.1snCJ4Pj7MHkGzpsyxl2v_d-KN0"); 
client3.login("NzYzMzc0MzkzMjUwMTUyNDg4.X323JA.glB3aMn1kBoCKqAN8SW1VzMp9ys"); 
client4.login("NzYzMzgxMjcyOTYxNjEzODY2.X324pg.TIy5JyYonOEVArPB8VBayiW91XE"); 
client5.login("NzYzMzgyNDEwMTEyMTM5Mjg0.X325zQ.AoVi1uF9lSFgnP0YqVb_WSHk0SQ"); 
client6.login("NzYzMTYyNzEwODY2NTI2MjQ5.X328aA.eN5QjNYFDVloX3AySiJvEgf5HFM"); 
